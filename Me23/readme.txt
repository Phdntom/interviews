...
Please provide a Powerpoint, Word or PDF that answers the questions below.
In addition, please attach the source code for your analysis (ideally,
this should R or Python code). We specifically want to see the code you
use to read in the files, create plots, perform statistical analysis, etc.
...
3. Is the change in daily sales at the date you selected statistically
   significant? If so, what is the p-value?

4. Does the data suggest that the change in daily sales is due to a shift in
   the proportion of male-vs-female customers? Please use plots to support your
   answer (a rigorous statistical analysis is not necessary).
